 ...
 *
 * This event is dispatched by an interactive Game Object if a pointer is moved
 * while over it.
 *
 * Listen to this event from a Game Object using: `on(gameObject, 'pointermove',
 * listener)`.
 ...
 */
#define ZEN_INPUT_GAMEOBJECT_POINTER_MOVE "pointermove"
