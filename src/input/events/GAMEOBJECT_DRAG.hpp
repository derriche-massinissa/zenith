 ...
 *
 * This event is dispatched by an interactive Game Object if a pointer moves while
 * dragging it.
 *
 * Listen to this event from a Game Object using: `on(gameObject, "drag",
 * listener)`.
 ...
 */
#define ZEN_INPUT_GAMEOBJECT_DRAG "drag"
