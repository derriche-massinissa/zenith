 ...
 * pressed down on _any_ interactive Game Object.
 *
 * Listen to this event from within a Scene using: `input.on("gameobjectdown",
 * listener)`.
 *
 ...
 * ZEN_INPUT_GAMEOBJECT_POINTER_DOWN event instead.
 *
 * The event hierarchy is as follows:
 *
 * 1. ZEN_INPUT_GAMEOBJECT_POINTER_DOWN
 * 2. ZEN_INPUT_GAMEOBJECT_DOWN
 * 3. ZEN_INPUT_POINTER_DOWN
 *
 ...
 */
#define ZEN_INPUT_GAMEOBJECT_DOWN "gameobjectdown"
