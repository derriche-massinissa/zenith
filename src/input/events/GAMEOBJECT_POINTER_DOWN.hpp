 ...
 *
 * This event is dispatched by an interactive Game Object if a pointer is pressed
 * down on it.
 *
 * Listen to this event from a Game Object using: `on(gameObject, "pointerdown",
 * listener)`.
 ...
 */
#define ZEN_INPUT_GAMEOBJECT_POINTER_DOWN "pointerdown"
