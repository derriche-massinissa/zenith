 ...
 *
 * Listen to this event from a Game Object using: `on(gameObject, "pointerup",
 * listener)`.
 ...
 * See Zen::etInteractive for more details.
 *
 ...
 */
#define ZEN_INPUT_GAMEOBJECT_POINTER_UP "pointerup"
