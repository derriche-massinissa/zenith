 ...
 * 
 * This event is dispatched when the Fade In Effect of a camera starts.
 * 
 * Listen to it using `events.on("camerafadeinstart", listener)`.
 *
 * @since 0.0.0
 * 
 ...
 */
#define ZEN_EVENTS_CAMERAS_FADE_IN_START  "camerafadeinstart"
